...
import com.overnightstay.view.house_of_distribution.finishminigame.FinishGameMemoDistrFragment
...
interface MainModule {
    ...
    @ContributesAndroidInjector
    fun bindFinishGameMemoDistrFragment(): FinishGameMemoDistrFragment

...
class NightBusTrainingFragment : Fragment() {
    ...
    private val arrayRadioButtonText1 = mutableListOf(
        "","","","","Конечно, Михаил. Вот, возьмите суп и хлеб. Хотите узнать больше о том, как мы можем вам помочь?","",
        "Это 'Ночной автобус' от 'Ночлежки'. Мы ездим по городу и раздаём еду бездомным, оказываем первую помощь и консультируем по любым вопросам","",
    ...
    private val arrayRadioButtonText2 = mutableListOf(
        ...
        "Ведите себя спокойно, уважайте других людей, пропускайте вперед женщин и инвалидов. Мы работаем по графику и время указано на брошюре","","",
        "Если вам станет плохо, сразу скажите об этом любому волонтёру. Мы можем оказать первую помощь, дать таблетки и вызвать машину скорой помощи.","",
        "Вам нужно самому решить, что делать. Мы не можем помочь в таких вопросах.","",
        "Не откладывайте. Чем раньше вы начнете, тем быстрее мы сможем вам помочь. Я здесь, чтобы поддержать вас."
    )

...
class DialogInTheBuilding2Fragment : Fragment() {
    ...
    private val arrayRadioButtonText1 = mutableListOf(
        ...
        "Это бесплатно. Здесь вы можете помыться, подстричься, вам выдадут туалетные\nпринадлежности, и если вы хотите постирать одежду, вам выдадут чистый халат.","",
        ...
        "Для начала вам нужно прийти в консультационный центр и обратится к социальному\nработнику. Рассказать, что с вами произошло. Вам обязательно помогут."
        )

    private val arrayRadioButtonText2 = mutableListOf(
        "","","Это только для тех, кто уже зарегистрировался у нас.","",
        "Это только для тех, кто уже зарегистрировался у нас.","",
        "Вы можете посещать Неравнодуш один раз в неделю. Дежурный на входе проверит\nвашу температуру","",
        "У нас тщательная обработка душевых кабинок, туалетов, зоны ожидания: уборка после\nкаждого клиента, уборка в конце рабочего дня, и генеральная уборка один раз в месяц.","",
